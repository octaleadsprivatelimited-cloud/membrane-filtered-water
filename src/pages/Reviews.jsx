...
const Reviews = () => {
  const reviews = [
    { name: "Sarah Jenkins", role: "Homeowner", text: "The water tastes incredible. We used to buy bottled water every week, but the AquaPure system has completely replaced that. The installation was seamless.", rating: 5 },
    ...
    <div className="w-full bg-slate-50 min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 mb-4">See what our customers are saying about AquaPure.</p>
