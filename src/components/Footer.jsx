      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mb-4">Subscribe for tips and offers.</p>
            <form className="flex" onSubmit={(e) => e.preventDefault()}>
              <input 
                type="email" 
                placeholder="Email address" 
                className="px-4 py-2 w-full bg-slate-800 border border-slate-700 rounded-l-md focus:outline-none focus:border-secondary text-sm"
              />
